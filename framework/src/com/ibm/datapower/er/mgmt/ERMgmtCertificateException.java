 ...
 * Is a subclass of ERMgmtException and is used when catching generic ERMgmtExceptions
...
public class ERMgmtCertificateException extends ERMgmtException {
     ...
     * 
     */
    ERMgmtCertificateException(String message) {
        super(message);
    }
    /**
     * Construction for a Certificate Exceptionwith a null certificate and a given message and a given cause
     * @param message the message of the exception. 
     * @param e the Throwable cause of the exception
     */
    ERMgmtCertificateException(String message, Throwable e) {
        super(message, e);
    }
     ...
     * 
     */
    ERMgmtCertificateException(String message, X509Certificate mycert) {
        this(message);
        certificate = mycert;
    }
